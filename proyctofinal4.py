...
def abrir_reportes():
    ...
    frame_totales = tk.Frame(ventana, bg="#f2f2f2")
    frame_totales.pack(pady=15)

    lbl_total_productos = tk.Label(
        frame_totales,
        text=f"Total de productos vendidos: {total_productos}",
        font=("Arial", 12, "bold"),
        bg="#f2f2f2"
    )
    lbl_total_productos.pack(anchor="w")

    lbl_total_general = tk.Label(
        frame_totales,
        text=f"Total general vendido: ${total_general:,.2f}",
        font=("Arial", 12, "bold"),
        bg="#f2f2f2"
    )
    lbl_total_general.pack(anchor="w")
...
# BOTONES PRINCIPALES
# -------------------------
ttk.Button(ventana, text="Registro de Productos", command=abrir_registro_productos, style="MiBoton.TButton").pack(pady=10)
ttk.Button(ventana, text="Registro de Ventas", command=abrir_registro_ventas, style="MiBoton.TButton").pack(pady=10)
ttk.Button(ventana, text="Reportes", command=abrir_reportes, style="MiBoton.TButton").pack(pady=10)
ttk.Button(ventana, text="Acerca de", command=abrir_acerca_de, style="MiBoton.TButton").pack(pady=10)
